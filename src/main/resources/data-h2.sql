...
insert into FEED (ID, DESCRIPTION, LINK, TITLE) values (4, 'Traumatic hemorrhage of cerebrum, unspecified, with loss of consciousness of 31 minutes to 59 minutes, sequela', 'http://apple.com/in/tempus/sit/amet/sem.xml', 'Consequences of Love');
...
insert into FEED (ID, DESCRIPTION, LINK, TITLE) values (9, 'Nondisplaced midcervical fracture of left femur, subsequent encounter for open fracture type IIIA, IIIB, or IIIC with nonunion', 'http://npr.org/orci/nullam/molestie.jpg', 'Man Who Couldn''t Say No');
...
insert into FEED_ENTRY (ID, AUTHOR, DESCRIPTION, GUID, LINK, TITLE, FEED_ID) values (11, 'Shell Moisey', 'Burn of unspecified degree of left toe(s) (nail), initial encounter', 'a101a195-4785-4133-a955-33001619e1b3', 'https://yellowpages.com/vestibulum/ante/ipsum/primis.html', 'Extraordinary Adventures of Mr. West in the Land of the Bolsheviks', 1);
